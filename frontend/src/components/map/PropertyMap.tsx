...
function ResizeInvalidator() {
  ...
  useEffect(() => {
    ...
    const timeoutOne = setTimeout(invalidate, 50);
    const timeoutTwo = setTimeout(invalidate, 250);
...
function MapLayerToggle({ layer, onChange }) {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://cache.kartverket.no/v1/wmts/1.0.0/toporaster/default/webmercator/12/1164/2154.png"
          alt="Terrenglag"
          className="h-full w-full object-cover"
        />
      </button>
